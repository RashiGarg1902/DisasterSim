...
function DashBoard() {
  ...
  if (!mapGenerated)
    return (
      <div className="bg h-screen flex-1 bg-gray-100 text-black">
        <div className="h-5/6 bg-gray-700 grid grid-cols-8 grid-rows-10 gap-[2px]">
          <div className="animate-pulse row-start-4 col-start-3 col-span-4 row-span-4 text-slate-300 text-5xl">
            Loading map data...
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <div className="flex flex-col justify-around bg-gray-700 text-black ">
        <div className="flex flex-row justify-between ">
          <h2 className="text-slate-300 text-2xl pt-2">Day {day}</h2>
          <h2 className="text-slate-300 text-2xl pt-2">
            {moraleIcon}
            {morale}%
          </h2>
          <h2 className="text-slate-300 text-2xl pt-2">
          ...
          <button
            className="bg-gray-500 text-slate-300 m-2 rounded-md px-6 py-1 text-lg w-fit h-fit text-nowrap hover:bg-gray-400 hover:text-xl"
            onClick={() => {
